...
% ITRFtoIRF is a function decorator for MATLAB's dcmeci2ecef. 
%   dcmeci2ecef returns the rotation matrix associated to the
%   transformation of a position vector in IRF (Inertial, Earth-centred) to ITRF
%   (Earth-fixed, Earth-centered).
%   See: https://www.mathworks.com/help/aerotbx/ug/dcmeci2ecef.html
% 
%   The purpose of the decorator is to provide abstraction to the variable inputs 
%   parsed to dcmeci2ecef, to the calculation of higher order terms, and to
%   include performance improvements. Please see the thesis for more information. 
%
%   Includes polarmotion, CIP location, time transformation, and leap
%   second adjustment terms which are not included by default. Uses the IAU
%   2000/2006 resolution, as to comply with the IERS-2010 recommendations. 
% 
%   When the higher-order terms are not used, there is an error up to 100 m
%   against JPL's transformations. When using and accounting for the
%   higher-order terms, there is an error at most 0.08m against JPL. This
%   test was made by comparing GNV1B_ITRF data products by JPL for GRACE-FO
...
%   dimension. This is an identical operation if I were to calculate each
...
%   simultaneously. If software lags, or computer runs into out of memory
